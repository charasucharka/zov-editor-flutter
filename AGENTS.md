...
- External URLs (GitHub, Discord, level upload hub, etc.) live in `assets/meta/links.json` and are loaded via `lib/data/app_links.dart` — change links there rather than hardcoding in Dart.
