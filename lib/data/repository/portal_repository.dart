...
class PortalRepository {
  ...
  static const List<PortalWorldDef> portalDefinitions = [
    ...
    PortalWorldDef(typeCode: 'pvz1_renai_romeo_hard', name: 'Romeo hard', representativeZombies: ['zombie_renai_romeo_memo']),
    PortalWorldDef(typeCode: 'pvz1_renai_romeo2_hard', name: 'Romeo hard 2', representativeZombies: ['zombie_renai_romeo_memo1']),
    PortalWorldDef(typeCode: 'pvz1_renai_juliet_hard', name: 'Juliet hard', representativeZombies: ['zombie_renai_juliet_memo']),
    PortalWorldDef(typeCode: 'pvz1_renai_juliet2_hard', name: 'Juliet hard 2', representativeZombies: ['zombie_renai_juliet_memo1']),
    PortalWorldDef(typeCode: 'pvz1_renai_sherlock_hard', name: 'Sherlock hard', representativeZombies: ['zombie_renai_sherlock_memo']),
